...
| 2 | 销项管理 | 扫码开票 | `/platform/scanCode` | `platform-scanCode` | done | pending | done | pending | pending | P1，采二维码、链接、提交状态 |
| 3 | 销项管理 | 扫码记录 | `/platform/scanRecords` | `platform-scanRecords` | done | pending | done | pending | pending | P1，采筛选、表格、详情 |
| 4 | 销项管理 | 开票记录 | `/platform/records` | `platform-records` | done | action-audited | done | done | mapped | P0，发票列表/详情/下载/交付动作；真实 Network 待补 |
| 5 | 销项管理 | 订单开票 | `/platform/billIssue` | `platform-billIssue` | done | pending | done | pending | pending | P1，采订单开票列表和开票动作 |
| 6 | 销项管理 | 开票申请单 | `/platform/invoiceApplication` | `platform-invoiceApplication` | done | pending | done | pending | visual-only | 只参考视觉和字段，不恢复 ERP 旧申请主线 |
| 7 | 销项管理 | 红字确认单 | `/platform/redMark` | `platform-redMark` | done | pending | done | pending | deferred | P1，高风险，真实动作后置 |
| 8 | 进项管理 | 快捷勾选 | `/income/scanCodeCheck` | `income-scanCodeCheck` | done | pending | done | pending | pending | P1，勾选入口、批量动作需标 L3 |
| 9 | 进项管理 | 手工勾选 | `/income/invoiceCheck` | `income-invoiceCheck` | done | action-audited | done | done | mapped | P0，进项发票选择和用途状态；真实勾选 L3 禁用 |
| 10 | 进项管理 | 勾选审核 | `/income/confirmCheck` | `income-confirmCheck` | done | pending | done | pending | pending | P1，采审核批次/确认动作 |
...
| 14 | 票据中心 | 签收 | `/billCenter/sign` | `billCenter-sign` | done | pending | done | pending | deferred | P1，高风险动作，先台账后真实签收 |
| 15 | 票据中心 | 查验 | `/billCenter/invoiceVerification` | `billCenter-invoiceVerification` | done | pending | done | pending | pending | P1，查验表单、结果、批量查验 |
| 16 | 票据中心 | 取票设置 | `/billCenter/accessSetting` | `billCenter-accessSetting` | done | pending | done | pending | pending | P1，取票账号/规则配置 |
| 17 | 票据中心 | 任务管理 | `/billCenter/taskManagement` | `billCenter-taskManagement` | done | pending | done | pending | pending | P1，同步任务、失败重试、下载中心关联 |
...
| 24 | 基础信息 | 商品信息 | `/bussiness/info` | `bussiness-info` | done | pending | done | pending | pending | P2，商品/税编资料 |
| 25 | 基础信息 | 客户管理 | `/bussiness/customer` | `bussiness-customer` | done | pending | done | pending | pending | P2，客户资料库 |
| 26 | 基础信息 | 开票额度配置 | `/bussiness/credit` | `bussiness-credit` | done | pending | done | pending | pending | P2，额度配置，和开票页额度展示关联 |
| 27 | 基础信息 | 配置管理 | `/bussiness/configurationManagement` | `bussiness-configurationManagement` | done | pending | done | pending | deferred | P2/P3，先判定 ERP 是否需要 |
| 28 | 系统设置 | 组织管理 | `/system/dept` | `system-dept` | done | pending | done | pending | deferred | P3，ERP 权限体系为主 |
| 29 | 系统设置 | 部门管理 | `/system/departmentInfo` | `system-departmentInfo` | done | pending | done | pending | deferred | P3，ERP 权限体系为主 |
| 30 | 系统设置 | 角色管理 | `/system/role` | `system-role` | done | pending | done | pending | deferred | P3，ERP 权限体系为主 |
| 31 | 系统设置 | 网上办税信息 | `/system/onlineTaxationInfo` | `system-onlineTaxationInfo` | done | pending | done | pending | pending | P2，数电/电子税局配置优先 |
| 32 | 系统设置 | 用户管理 | `/system/user` | `system-user` | done | pending | done | pending | deferred | P3，ERP 用户体系为主 |
| 33 | 顶部入口 | 下载中心 | `/downloadCenter` | `downloadCenter` | done | pending | done | pending | pending | P1，版式文件/任务下载 |
...
4. P1/P2/P3 按缺口台账继续补接口、状态截图、demo 和数据血缘。
